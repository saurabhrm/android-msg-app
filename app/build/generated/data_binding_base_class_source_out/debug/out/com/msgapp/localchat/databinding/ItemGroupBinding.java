...
public final class ItemGroupBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView tvHostAddress;

  @NonNull
  public final TextView tvMemberCount;

  private ItemGroupBinding(@NonNull CardView rootView, @NonNull TextView tvGroupName,
      @NonNull TextView tvHostAddress, @NonNull TextView tvMemberCount) {
    this.rootView = rootView;
    this.tvGroupName = tvGroupName;
    this.tvHostAddress = tvHostAddress;
  ...
  public static ItemGroupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvHostAddress;
      TextView tvHostAddress = ViewBindings.findChildViewById(rootView, id);
      if (tvHostAddress == null) {
        break missingId;
      }
      ...
      return new ItemGroupBinding((CardView) rootView, tvGroupName, tvHostAddress, tvMemberCount);
    }
